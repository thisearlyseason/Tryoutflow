...
select is((select count(*) from public.audit_logs where organization_id='20202020-2020-4020-8020-202020202020' and action='checkin.completed'),1::bigint,'successful check-in appends one audit event');
