...
| P06 | Analytics never blocks score persistence                                                     | `run test:contract` includes `tests/contract/analytics-provider.contract.test.ts`, but production failure/latency isolation from score persistence is not certified and remains manual.                                                                            |
